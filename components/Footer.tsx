      ...
      <div className="container mx-auto px-4 max-w-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link href="/" className="block mb-4">
              <span className="font-heading text-h2 font-bold text-white">
                HandcraftBK
              </span>
            </Link>
            <p className="text-subtle mb-6">
              HandcraftBK made with love and passion by artisans around the
              world.
            </p>
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/chuquanpho29"
                target="_blank"
                aria-label="Facebook"
              >
                <svg
              ...
              <a
                href="https://www.instagram.com/hunglt29"
                target="_blank"
        ...
        <div className="border-t border-accent mt-12 pt-6 text-center">
          <p className="text-subtle text-small">
            © {new Date().getFullYear()} HandcraftBK. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
