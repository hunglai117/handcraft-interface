...
export default function SearchBox({ isOpen, onClose, onOpen }: SearchBoxProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 backdrop-blur-sm">
      ...
      <div className="flex justify-center px-4 text-center" style={{ marginTop: '30px' }}>
        <div
        ...
        >
          ...
          <div className="mt-8 border-t border-gray-100 pt-4">
            <div className="flex justify-between items-center">
              ...
              <button className="text-xs text-primary hover:underline cursor-pointer">Clear all</button>
            </div>
            <div className="mt-2 space-y-2">
              {['Handcrafted vase', 'Wooden bowl', 'Ceramic plate'].map(term => (
                <button
                  key={term}
                  onClick={() => {
                    setSearchQuery(term);
