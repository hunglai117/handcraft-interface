    ...
    <Layout title="Contact Us">
      ...
      <section className="relative h-[300px]">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div>
            <h1 className="text-white font-heading text-4xl md:text-5xl font-bold mb-2">Contact Us</h1>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="ml-9">
                    <p className="text-gray-600 mb-1">
                      General Inquiries:{' '}
                      <a href="mailto:chuquanpho29@gmail.com" className="text-primary hover:underline">
                ...
                <div>
                  ...
                  <div className="ml-9">
                    <p className="text-gray-600 mb-1">
                      Phone:{' '}
                      <a href="tel:+84783225944" className="text-primary hover:underline">
                        84783225944
                      </a>
                    </p>
                    <p className="text-gray-600">Hours: Monday-Friday, 9am-6pm PT</p>
                  </div>
                </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-h1 text-center mb-12">Frequently Asked Questions</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-h3 mb-3">What are your shipping times?</h3>
              <p className="text-gray-600">
                We typically process orders within 1-2 business days. Domestic shipping takes 3-5 business days, while
                international shipping can take 7-14 business days depending on the destination.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-h3 mb-3">Do you offer returns or exchanges?</h3>
              <p className="text-gray-600">
                Yes, we offer returns and exchanges within 30 days of purchase. Items must be in original condition.
                Please note that custom orders are non-returnable.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-h3 mb-3">How do I track my order?</h3>
              <p className="text-gray-600">
                Once your order ships, you'll receive a confirmation email with tracking information. You can also log
                into your account to view order status.
              </p>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-heading text-h3 mb-3">Can I request custom orders?</h3>
              <p className="text-gray-600">
                Absolutely! We love working on custom pieces. Please contact us with your ideas and requirements, and
                we'll connect you with an artisan who specializes in that craft.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-subtle">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8">
            Subscribe to our newsletter for updates on new artisans, collections, and exclusive offers.
          </p>
