            ...
            <div className="bg-white rounded-lg p-6">
              {activeTab === 'description' && (
                <div>
                  ...
                  <p className="mb-4">
                    {product.description} Our artisans spend countless hours crafting each piece to ensure exceptional
                    quality and uniqueness.
                  </p>
                  <p>
                    This beautiful {product.name.toLowerCase()} will add charm and character to your home. Each piece
                    tells a story and connects you to traditional craftsmanship from around the world.
                  </p>
                </div>
              )}
              ...
              {activeTab === 'materials' && (
                <div>
                  ...
                  <p className="mb-4">This product is lovingly made using the following materials:</p>
                  <ul className="list-disc pl-5 mb-4">
                    {product.materials.map((material, index) => (
                      <li key={index} className="mb-2">
                        ...
                        {material === 'Oak' &&
                          ' Premium hardwood known for its durability and beautiful grain patterns.'}
              ...
              {activeTab === 'care' && (
                <div>
                  ...
                  <p className="mb-4">
                    To keep your {product.name.toLowerCase()} looking beautiful for years to come, please follow these
                    care instructions:
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-b border-gray-200 pb-6">
                      ...
                      <p className="text-gray-600 mb-2">
                        This is even more beautiful in person! The craftsmanship is excellent and the materials are high
                        quality. I've received so many compliments.
                      </p>
                    ...
                    <div className="border-b border-gray-200 pb-6">
                      ...
                      <p className="text-gray-600 mb-2">
                        Love the unique style and how it complements my decor. Shipping was fast and it came
                        well-packaged. Would buy from this shop again.
                      </p>
                      <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <form>
                        ...
                        <div className="mb-4">
                          <label className="block mb-2 font-medium" htmlFor="review-title">
                            Review Title
                          </label>
                          <input
                            type="text"
                        ...
                        <div className="mb-4">
                          <label className="block mb-2 font-medium" htmlFor="review-body">
                            Review
                          </label>
                          <textarea
                            id="review-body"
