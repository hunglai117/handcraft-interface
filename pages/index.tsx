...
export default function Home() {
  ...
  const prevSlide = () => {
    ...
    setCurrentIndex((prevIndex) =>
      prevIndex - 3 < 0
        ? Math.floor((featuredProducts.length - 1) / 3) * 3
        : prevIndex - 3
    );
  };
    ...
    <Layout title="Home">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-xl">
            <h1 className="text-white text-4xl md:text-5xl font-bold mb-4">
              Welcome to HandcraftBK!
            </h1>
            <p className="text-white text-lg mb-8">
              Discover unique handmade items created with passion and skill by
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="font-heading text-center text-h1 mb-12">
            Featured Categories
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center flex-col">
            ...
            <p className="mb-4 text-center">
              We started HandcraftBK with a simple mission: to celebrate and
              share the beauty of handmade crafts with the world while
              supporting skilled artisans. Each item in our collection is
              carefully selected for its quality, uniqueness, and the story
              behind it. We work directly with artisans to ensure fair
