...
export default function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  ...
  const products = [
    ...
    },
    {
      ...
      image: '/images/insta-1.jpg',
      category: 'Home Decor',
      description: 'Hand-thrown ceramic vase with unique glazing, each piece is one-of-a-kind.',
    ...
    },
    {
      ...
      image: '/images/insta-1.jpg',
      category: 'Wall Art',
      description: 'Intricate macrame wall hanging, handcrafted with 100% cotton rope.',
      materials: ['Cotton'],
      featured: true,
    },
    {
    ...
    },
    {
      ...
      image: '/images/insta-1.jpg',
      category: 'Kitchen',
      description: 'Set of 4 hand-painted pottery plates with artisanal designs.',
